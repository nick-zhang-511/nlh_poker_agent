...
try:
    ...
    print("ERROR: Could not locate %s. Please ensure your environment library load path is set properly." % pbots_calc)
    sys.exit(1)
...
class Results:
    def __init__(self, res):
        ...
        for i in range(self.size):
            ...
            self.hands.append(res.hands[i].decode())
...
def calc(hands, board, dead, iters):
    ...
    # Convert to bytes because of Python3 Darknet
